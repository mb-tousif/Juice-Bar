...
export default function Store() {
  return (
    <div className="text-center">
      <h1 className="text-xl sm:text-2xl md:text-3xl text-center font-bold text-lime-800 mt-2 mb-4">Our Juice Bar Items</h1>
      <ul className="flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4" id="tabs-tab3" role="tablist">
        <li className="nav-item mx-auto my-auto" role="presentation">
          <Link
            to="store/juice"
            className="w-full font-medium border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100 focus:border-transparent">
            Juice
          </Link>
          <Link
            to="store/bowl"
